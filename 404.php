  ...
  <main id="primary" class="content__main" role="main">
    <div class="main">
      <section class="error-404 not-found">
        <header class="main__header--404">
          <h1 class="main__header--404__title"><?php _e('Oops! That page can&rsquo;t be found.', '_s'); ?></h1>
        </header><!-- .page-header -->
        ...
        <div class="page--404">
          ...
          <?php if (_s_categorized_blog()) : // Only show the widget if site has multiple categories.  ?>
            <div class="widget widget_categories">
              <h2 class="widget__title"><?php _e('Most Used Categories', '_s'); ?></h2>
              <ul>
                <?php
